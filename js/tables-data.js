...
// foto) e depois conferidas ponto a ponto contra os valores legíveis nas
// fotos do posto (images/EC-EA-GC-GA-S10.webp, images/S500.webp,
// images/tabelaArqueacaoHistorica.webp) - bateram exatamente em cm 1, 50,
// 100, 124, 127, 128, 129, 150, 200, 248, 254 nas três tabelas. É o mesmo
// método que a ARXO usa (ver "Tabela de Arqueação Teórica" na foto), e é
// mais confiável do que ler centenas de números pequenos numa foto de
// celular. Ainda assim, ficam marcadas como `verificado: false` - o gerente
// deve conferir contra a tabela impressa oficial antes de usar em produção.
// Qualquer linha pode ser corrigida em Configurações > Tabelas.
//
// Nota: o rascunho do PRD (critério de aceite #1) cita "129 cm → 7.391 L".
// O valor real na tabela gerada/foto é 124 cm → 7.391 L (129 cm → 7.773 L).
// Muito provavelmente um typo de digitação no PRD (124↔129). Ver CLAUDE.md.
